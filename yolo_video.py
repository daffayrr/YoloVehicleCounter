...
list_of_vehicles = ["sepeda","car","motorbike","bus","truck", "train"]
...
def displayVehicleCount(frame, vehicle_count):
	count_total = str(vehicle_count)
	cv2.putText(
		frame, #Image	
		'Total Kendaraan: ' + count_total, #Label
		(20, 20), #Position
...
while True:
	...
	cv2.imshow('Smart Traffic Light System', frame)
...
print("[INFO] Menonaktifkan Frame...")
writer.release()
videoStream.release()
